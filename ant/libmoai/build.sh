...
#================================================================#
	...
	if [ -f libs/package.txt ]; then
		...
		existing_use_luajit=$( sed -n '6p' libs/package.txt )
		existing_adcolony_flags=$( sed -n '7p' libs/package.txt )
		existing_billing_flags=$( sed -n '8p' libs/package.txt )
		existing_chartboost_flags=$( sed -n '9p' libs/package.txt )
		existing_crittercism_flags=$( sed -n '10p' libs/package.txt )
		existing_facebook_flags=$( sed -n '11p' libs/package.txt )
		...
		existing_with_moai_components=$( sed -n '15p' libs/package.txt )
		existing_use_yaml=$( sed -n '16p' libs/package.txt )
